...
Status: **P0, P1, and §5.2 (Data Components, the core of P2) done** — see §13. In progress on branch `fabric-port-1.20.1`. Remaining P2 scope: creative tabs, loot modifiers, inventories (§7).
...
3. **P2 Components & stacks** — §5.2 (D1) ✅ done (2026-08-31, error count 619→555 including a bundled jsr305 fix), §7 recipes ✅ and menus ✅ (done in §5.8). Remaining: §7 creative tabs, loot modifiers, inventories (`ItemStackHandler`→`Container`/`SimpleContainer`), relevant mixins (§10).
